...
import { inspectResponseLogJson, observeRequestTransport } from "../request-log";
...
import {
  recordDownstreamCancelled,
  recordSyntheticTerminal,
  transportObserver,
...
export async function deliverPassthroughResponse(
  ...
  sidecarState: Pick<ResponsesSidecarAuth, "openAiSearchSidecar">,
  ...
  const { openAiSearchSidecar } = sidecarState;
