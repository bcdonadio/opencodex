...
import { noteAttemptSend, observeRequestTransport, recordAdapterReasoning, recordAdapterTier } from "../request-log";
import { normalizeLogConversationId } from "../request-log-conversation";
import { recordContextTransformation, transportObserver } from "../transaction-capture";
...
export async function executeResponsesSidecars(
  ...
  transportState: Pick<
    ...
    | "oauthDispatch"
  >,
  sidecarState: Pick<ResponsesSidecarAuth, "routedCompaction" | "openAiSearchSidecar">,
  ...
  const { routedCompaction, openAiSearchSidecar } = sidecarState;
