...
import { captureResponsesIngressCredentialOwnership } from "./core-auth";
...
export async function handleResponses(
  ...
  const credentialOwnership = captureResponsesIngressCredentialOwnership(req.headers, config, options);
  try {
