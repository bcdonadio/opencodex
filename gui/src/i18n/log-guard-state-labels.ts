...
const LABELS: Record<Locale, StateLabels> = {
  en: {
    ...
    mode: { off: "Disabled", compat: "Compatibility", quiet: "Quiet", collision: "Unknown" },
  },
  de: {
    ...
    mode: { off: "Deaktiviert", compat: "Kompatibilität", quiet: "Leise", collision: "Unbekannt" },
  },
  fr: {
  ...
  ko: {
    ...
    mode: { off: "비활성", compat: "호환 모드", quiet: "조용한 모드", collision: "알 수 없음" },
  },
  zh: {
    ...
    mode: { off: "已禁用", compat: "兼容模式", quiet: "静默模式", collision: "未知" },
  },
  "zh-TW": {
    ...
    mode: { off: "已停用", compat: "相容模式", quiet: "靜默模式", collision: "未知" },
  },
  ru: {
    ...
    mode: { off: "Отключено", compat: "Совместимость", quiet: "Тихий режим", collision: "Неизвестно" },
  },
  ja: {
    ...
    mode: { off: "無効", compat: "互換モード", quiet: "静音モード", collision: "不明" },
  },
  tr: {
    ...
    mode: { off: "Devre dışı", compat: "Uyumluluk", quiet: "Sessiz", collision: "Bilinmiyor" },
  },
};
