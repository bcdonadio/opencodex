...
export const ja: Record<TKey, string> = {
  "logs.diagnostics.title": "診断",
  "logs.diagnostics.http": "元の HTTP ステータス",
  "logs.diagnostics.mapped": "変換後のステータス",
  "logs.diagnostics.output": "失敗前の出力",
  "logs.diagnostics.terminal": "終了イベントの発生元",
  "logs.diagnostics.phase": "転送フェーズ",
  "logs.diagnostics.usage": "使用量が欠落した理由",
  "logs.diagnostics.observed": "観測済み",
  "logs.diagnostics.derived": "導出済み",
  "logs.diagnostics.unsupported": "未対応",
  "logs.diagnostics.notObserved": "未観測",
  "logs.diagnostics.redacted": "編集済み",
  "logs.diagnostics.truncated": "切り詰め済み",
  "logs.diagnostics.unknown": "不明",
  "logs.diagnostics.unavailable": "未記録",
  "logs.diagnostics.evidence": "識別情報とトランザクションの証跡",
  "logs.diagnostics.lifecycle": "ライフサイクル",
  "logs.diagnostics.availability": "フィールドの利用可否",
  "logs.diagnostics.attempts": "試行と送信",
  "logs.diagnostics.downloading": "ダウンロード中…",
  "logs.diagnostics.download": "サポートバンドルをダウンロード",
...
"common.discard": "破棄",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "logs.transport.rowTitle": "このリクエストで観測されたクライアントと上流の通信方式",
  "logs.account.row": "アカウント {account}",
  "logs.account.main": "メイン",
  "logs.account.withAlias": "{alias} ({label})",
  "logs.notRecorded": "未記録",
  "logs.col.status": "状態",
  ...
  "logs.detail.attempt.upstreamTransport": "上流の通信方式",
  "logs.detail.attempt.account": "アカウント",
  ...
  "logs.detail.clientTransport": "クライアントの通信方式",
  "logs.detail.upstreamTransport": "上流の通信方式",
  "logs.detail.account": "アカウント",
