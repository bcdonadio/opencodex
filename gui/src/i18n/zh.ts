...
export const zh: Record<TKey, string> = {
  "logs.diagnostics.title": "诊断",
  "logs.diagnostics.http": "原始 HTTP 状态",
  "logs.diagnostics.mapped": "映射状态",
  "logs.diagnostics.output": "失败前的输出",
  "logs.diagnostics.terminal": "终止来源",
  "logs.diagnostics.phase": "传输阶段",
  "logs.diagnostics.usage": "用量缺失原因",
  "logs.diagnostics.observed": "已观测",
  "logs.diagnostics.derived": "已推导",
  "logs.diagnostics.unsupported": "不支持",
  "logs.diagnostics.notObserved": "未观测",
  "logs.diagnostics.redacted": "已脱敏",
  "logs.diagnostics.truncated": "已截断",
  "logs.diagnostics.unknown": "未知",
  "logs.diagnostics.unavailable": "未记录",
  "logs.diagnostics.evidence": "标识与事务证据",
  "logs.diagnostics.lifecycle": "生命周期",
  "logs.diagnostics.availability": "字段可用性",
  "logs.diagnostics.attempts": "尝试与发送",
  "logs.diagnostics.downloading": "正在下载…",
  "logs.diagnostics.download": "下载支持包",
...
"common.discard": "丢弃",
 ...
 "logs.filter.conversation.clear": "清除",
  ...
  "logs.transport.rowTitle": "此请求观测到的客户端和上游传输方式",
  "logs.account.row": "账号 {account}",
  "logs.account.main": "主账号",
  ...
  "logs.detail.attempt.upstreamTransport": "上游传输",
  "logs.detail.attempt.account": "账号",
  ...
  "logs.detail.clientTransport": "客户端传输",
  "logs.detail.upstreamTransport": "上游传输",
