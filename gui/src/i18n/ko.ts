...
export const ko: Record<TKey, string> = {
  "logs.diagnostics.title": "진단",
  "logs.diagnostics.http": "원본 HTTP 상태",
  "logs.diagnostics.mapped": "변환된 상태",
  "logs.diagnostics.output": "실패 전 출력",
  "logs.diagnostics.terminal": "종료 출처",
  "logs.diagnostics.phase": "전송 단계",
  "logs.diagnostics.usage": "사용량 누락 사유",
  "logs.diagnostics.observed": "관측됨",
  "logs.diagnostics.derived": "도출됨",
  "logs.diagnostics.unsupported": "지원되지 않음",
  "logs.diagnostics.notObserved": "관측되지 않음",
  "logs.diagnostics.redacted": "가림 처리됨",
  "logs.diagnostics.truncated": "잘림",
  "logs.diagnostics.unknown": "알 수 없음",
  "logs.diagnostics.unavailable": "기록되지 않음",
  "logs.diagnostics.evidence": "식별 정보 및 트랜잭션 증거",
  "logs.diagnostics.lifecycle": "수명 주기",
  "logs.diagnostics.availability": "필드 가용성",
  "logs.diagnostics.attempts": "시도 및 전송",
  "logs.diagnostics.downloading": "다운로드 중…",
  "logs.diagnostics.download": "지원 번들 다운로드",
...
"common.discard": "버리기",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "logs.transport.rowTitle": "이 요청에서 관찰된 클라이언트 및 업스트림 전송 방식",
  "logs.account.row": "계정 {account}",
  "logs.account.main": "기본 계정",
  "logs.account.withAlias": "{alias} ({label})",
  "logs.notRecorded": "기록되지 않음",
  "logs.col.status": "상태",
  "logs.col.tokens": "토큰",
  ...
  "logs.detail.attempt.upstreamTransport": "업스트림 전송",
  "logs.detail.attempt.account": "계정",
  ...
  "logs.detail.clientTransport": "클라이언트 전송",
  "logs.detail.upstreamTransport": "업스트림 전송",
  "logs.detail.account": "계정",
