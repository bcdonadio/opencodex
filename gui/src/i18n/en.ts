 ...
 */
export const en = {
  "logs.diagnostics.title": "Diagnostics",
  "logs.diagnostics.http": "Raw HTTP status",
  "logs.diagnostics.mapped": "Mapped status",
  "logs.diagnostics.output": "Output before failure",
  "logs.diagnostics.terminal": "Terminal source",
  "logs.diagnostics.phase": "Transport phase",
  "logs.diagnostics.usage": "Missing usage reason",
  "logs.diagnostics.observed": "Observed",
  "logs.diagnostics.derived": "Derived",
  "logs.diagnostics.unsupported": "Unsupported",
  "logs.diagnostics.notObserved": "Not observed",
  "logs.diagnostics.redacted": "Redacted",
  "logs.diagnostics.truncated": "Truncated",
  "logs.diagnostics.unknown": "Unknown",
  "logs.diagnostics.unavailable": "Not recorded",
  "logs.diagnostics.evidence": "Identity and transaction evidence",
  "logs.diagnostics.lifecycle": "Lifecycle",
  "logs.diagnostics.availability": "Field availability",
  "logs.diagnostics.attempts": "Attempts and sends",
  "logs.diagnostics.downloading": "Downloading…",
  "logs.diagnostics.download": "Download support bundle",
...
"common.discard": "Discard",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "logs.transport.rowTitle": "Client and upstream transport observed for this request",
  "logs.account.row": "account {account}",
  "logs.account.main": "Main",
  ...
  "logs.detail.attempt.account": "Account",
