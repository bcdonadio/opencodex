...
export const de: Record<TKey, string> = {
  "logs.diagnostics.title": "Diagnose",
  "logs.diagnostics.http": "Ursprünglicher HTTP-Status",
  "logs.diagnostics.mapped": "Zugeordneter Status",
  "logs.diagnostics.output": "Ausgabe vor Fehler",
  "logs.diagnostics.terminal": "Quelle des Abschlusses",
  "logs.diagnostics.phase": "Transportphase",
  "logs.diagnostics.usage": "Grund für fehlende Nutzungsdaten",
  "logs.diagnostics.observed": "Beobachtet",
  "logs.diagnostics.derived": "Abgeleitet",
  "logs.diagnostics.unsupported": "Nicht unterstützt",
  "logs.diagnostics.notObserved": "Nicht beobachtet",
  "logs.diagnostics.redacted": "Geschwärzt",
  "logs.diagnostics.truncated": "Gekürzt",
  "logs.diagnostics.unknown": "Unbekannt",
  "logs.diagnostics.unavailable": "Nicht erfasst",
  "logs.diagnostics.evidence": "Identität und Transaktionsnachweise",
  "logs.diagnostics.lifecycle": "Lebenszyklus",
  "logs.diagnostics.availability": "Feldverfügbarkeit",
  "logs.diagnostics.attempts": "Versuche und Sendevorgänge",
  "logs.diagnostics.downloading": "Wird heruntergeladen…",
  "logs.diagnostics.download": "Supportpaket herunterladen",
...
"common.discard": "Verwerfen",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "logs.transport.http": "HTTP",
  "logs.transport.websocket": "WebSocket",
  "logs.transport.mixed": "HTTP + WebSocket",
  "logs.transport.row": "{inbound} → {upstream}",
  "logs.transport.rowTitle": "Für diese Anfrage beobachteter Client- und Upstream-Transport",
  "logs.account.row": "Konto {account}",
  "logs.account.main": "Hauptkonto",
  "logs.account.withAlias": "{alias} ({label})",
  "logs.notRecorded": "Nicht aufgezeichnet",
  ...
  "logs.detail.attempt.upstreamTransport": "Upstream-Transport",
  "logs.detail.attempt.account": "Konto",
  ...
  "logs.detail.clientTransport": "Client-Transport",
  "logs.detail.upstreamTransport": "Upstream-Transport",
  "logs.detail.account": "Konto",
