...
Ce mécanisme couvre aussi une conversation en cours basculée d’un modèle ChatGPT natif vers un modèle routé, dont l’historique rejoue à chaque tour suivant un message d’agent chiffré émis par le service en amont ([#4089](https://github.com/lidge-jun/opencodex/issues/4089)).
