...
Subagent routes inherit the exact reduced-refusal HTTP 403 entitlement classification and do not
retry another account; see [OpenAI tier entitlement handling](providers/openai-tiers.md#reduced-refusal-entitlement-denial).
